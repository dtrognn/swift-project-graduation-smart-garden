...
class CanopyViewController: BaseViewController {
    @IBOutlet var progressBar: ProgressBar!

    @IBOutlet var backgroundTimeoutiew: UIView!
    @IBOutlet var timeoutTextField: UITextField!
    @IBOutlet var fanConfigButton: UIButton!
    ...
    private func writeDataTimer(_ timeLeft: String) {
        writeDataToFirebase("timeoutCanopy", timeLeft) { [weak self] result in
            switch result {
            case .success:
